  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="item active">
        <img src="images/19 (2).jpeg" alt="Los Angeles" style="width:100%;">
          <div class="carousel-caption">
          <h3 style="color:#312B35">MSR meds</h3>
          <p style="color: #312B35;">For your health care!!</p>
        </div>
      </div>

      <div class="item">
        <img src="images/21 2.jpg" alt="Chicago" style="width:100%;">
          <div class="carousel-caption">
      ...
      <div class="item">
        <img src="images/23 22.jpg" alt="New york" style="width:100%;">
          <div class="carousel-caption">
          <h3>Call Ambulence</h3>
          <p>Call Ambulence of Nearby Hospital !!</p>
        </div>
      </div>
    </div>
...
<div class="parts container row" style="margin-top:30px;padding-bottom:30px; background:#EAEAEAE6;width: 101%;"> 
				...
				<div class="col-md-4 text-center" style="margin-top:60px;padding-bottom:30px;"> 
                    ...
                    <h3>With in your reach</h3>
                    <p>Find the nearest pharmacy around your home.</p>
				</div>
				<div class="col-md-4 text-center" style="margin-top:60px;padding-bottom:30px;">  
					<img src="images/33 2.jpg" alt="" />
                    <h3>Verified Medicine</h3>
                    <p>We deliver the medicines verified by professional chemists and drugists</p>
				</div>
    ...
    <div class="parts container row" style="padding-bottom:30px; background:#F2F2F2;width: 101%;"> 
        <div class="row">
				...
				<div class="col-md-6 text-center" style="margin-top:130px;padding-bottom:30px;"> 
                    ...
                    <h3>Our Stock</h3>
                    <p style="font-size: 18px;">We stock all kind of medicine including those impacting on covid19. We tend to serve every customer with their medical needs.</p>
				</div>
				...
				<div class="col-md-6 text-center" style="margin-top:130px;padding-bottom:30px;"> 
                    ...
                    <p style="font-size: 18px;">We deliver your medicine at your doorstep with all safety precautions.We believe, just a tiny bit of dely of the delivery can cost someones' life. So, our goal is to deliver the medicine as soon as possible to ensure better customer satisfaction.</p>
				</div>
    ...
    <div class="container row" style="width: 103%; background: #1a1a1ae6; margin-top: -30px;"> 
				<div class="col-md-12 text-center" style="margin-top:30px;padding-bottom:20px;"> 
                    ...
                    <p style="font-weight: bold; font-size: 15px;color: white;">Designed by @MSRclub</p>
				</div>
